...
import { skills, Tech_Stack, Stats } from "../utils/data";
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            A passionate full-stack developer skilled in designing interactive
            interfaces and building scalable backend systems. I bring a balanced
        ...
        <motion.div
          ...
          animate={isInView ? "visible" : "hidden"}
          variants={containerVariants}
          className="mt-20 grid grid-clos-2 md:grid-cols-4 gap-8"
        >
