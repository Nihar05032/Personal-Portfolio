      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            together. Fill out the form below or reach out via my social
            links—I'll get back to you soon!
          </motion.p>
        </motion.div>
                  ...
                  {isSubmitting ? (
                    <>
                      <motion.div
                        ...
                        className="w-4 h-4 border-2 border-2 border-white border-t-transparent rounded-full"
                      />
                      <span>Sending...</span>
                    </>
                  ) : (
              ...
              <div className="space-y-4">
                {Contact_Info.map((info, index) => (
                  ...
                  >
                    ...
                    >
                      <info.icons size={20} className="text-blue-500"/>
                    </div>
                    <div>
                      <div
                        className={`text-sm ${
        ...
        >
          ...
          >
            ...
            >
              Sometimes a conversation is worth a thousand message.
            </p>
            <motion.button
            whileHover={{y:-2,scale:1.05}}
            whileTap={{scale:0.98}}
            className={`px-6 py-3 rounded-full border font-medium transition-all duration-300 ${
              isDarkMode ? "border-gray-600 hover:border-blue-500 hover:text-blue-400"
